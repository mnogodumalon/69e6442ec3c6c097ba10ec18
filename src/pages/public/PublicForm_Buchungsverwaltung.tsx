...
const PROXY_BASE = '';
const APP_ID = '69e644309b0ad64abffd2cc8';
...
export default function PublicFormBuchungsverwaltung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Buchungsverwaltung — Formular</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="katzen"
              value={fields.katzen ?? ''}
              onChange={e => setFields(f => ({ ...f, katzen: e.target.value }))}
